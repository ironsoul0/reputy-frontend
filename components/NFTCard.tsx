...
export const NFTCard: FC<Props> = ({ title, price, image }) => {
  return (
    <div style={{ width: 250, backgroundColor: '#202a30' }} className="tw-rounded-2xl tw-bg-card-blue tw-h-max tw-text-soft-white tw-text-lg tw-font-normal tw-mb-16 md:tw-mb-0 tw-shadow-xl">
      <a className="tw-block tw-relative tw-rounded-t-xl tw-overflow-hidden" title="Equilibrium">
        ...
        <img src={image} style={{ width: 250, height: 200 }} alt="Equilibrium" />
      </a>
      ...
      <div className="p-3">
        ...
        <div>
          <p style={{ color: '#c7d2da' }} className="tw-text-white tw-text-xs mb-1">Примерная стоимость</p>
          <div className="tw-flex tw-items-center tw-text-white">
            <img src="/icon-ethereum.svg" alt="Ethereum icon" />
            <p className="tw-text-sm tw-font-semibold tw-tracking-wide tw-ml-1 tw-m-auto">{price}</p>
          </div>
        </div>
      </div>
    </div>
